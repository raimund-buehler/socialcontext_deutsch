...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/raimundbuehler/Documents/UNIDOCS/Python:Psychopy:RALT/RALT 2 - return of the RALT/RALT_PLD.py',
...
Welcome_text = visual.TextStim(win=win, name='Welcome_text',
    text="\n\nYou will be asked to choose between two symbols\nto the left and the right.\n\nYou can do so by clicking on the slider at the bottom.\n\nWhether you have chosen correctly will be\nindicated by a picture in the \ncenter of the screen.\n\nWe'll start with some trial runs,\nso you can better understand the experiment.\n\nPress any key to continue!\n\n",
    font=font_choice,
...
text_3 = visual.TextStim(win=win, name='text_3',
    text="You are about to see two symbols representing\nwords to the left and right of the screen. \n\nOne of them is likely to be interpreted as\nfriendly praise, while the other one is likely to\nbe interpreted as an insult.\n\nImagine that by choosing the symbol you will utter\nthis word to the person in the center of the\nscreen. From their reaction you can tell how it was interpreted.\n\nYou can choose the symbol by clicking on the slider at the bottom. \nYou can indicate the strength with which you want to choose the\nrespective symbol by clicking further to the right\nor left of the slider.\n\nLet's try a first round!\n\n",
    font=font_choice,
    pos=(0, 0), height=0.025, wrapWidth=70, ori=0, 
    color=color_choice, colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
